                        ...
                        if ((myRs.next())) {
                            ...
                            if (li.equals("true")) {
                                ...
                                JOptionPane.showMessageDialog(null,
                                        "NO internet connection or something is not right..");
                            }
                        }
    ...
    public static void event_top3() {
        SwingWorker<Void, Void> email = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try {
                    String filename = fw.getDefaultDirectory() + "\\Out-" + "netflix" + "(" + YEAR + "-" + month + "-"
                ...
                String save = fw.getDefaultDirectory() + "\\Out-" + "netflix" + "(" + YEAR + "-" + month + "-" + day
                        + "-" + hours + "-" + min + "-" + seconds + ").xls ";
                ...
                try {
                    ...
                    WebElement element1 = wait
                            .until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='id_userLoginId']")));
                    ...
                    WebElement element2 = wait
                            .until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='id_password']")));
                    ...
                    WebElement element3 = wait.until(ExpectedConditions
                            .elementToBeClickable(By.xpath("//button[@data-uia='login-submit-button']")));
                    ...
                    wait.until(ExpectedConditions.visibilityOfElementLocated(
                            By.xpath("/html/body/div[1]/div/div/div[1]/div[1]/div[2]/div/div/ul/li[1]//a"))).click();
                    ...
                    for (int j = 0; j <= ar.size(); j++) {
                        try {
                            ...
                            WebElement element4 = wait.until(
                                    ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='tab-Episodes']/a")));

                            element4.click();

                            WebElement element5 = wait.until(ExpectedConditions.elementToBeClickable(
                                    By.xpath("//*[@id='pane-Episodes']/div/div/div/div[1]/div[1]")));
                            ...
                            for (int e = 0; e < 10; e++) {
                                try {
                                    ...
                                    // driver.findElement((By.xpath("//*[@id='root']/div/div/div/div[1]/div[1]/div/main/div/div[2]/div/nav/div/button")));

                                    js23.executeScript(
                                            "document.querySelector('#pane-Episodes > div > div > div > div.nfDropDown.widthRestricted.theme-lakira > div').click();");
                                    e = 100;
                            ...
                            wait.until(ExpectedConditions.visibilityOfElementLocated(
                                    By.xpath("//*[@id='pane-Episodes']/div/div/div/div[1]/div[2]/ul")));

                            List<WebElement> season = driver.findElements(
                                    By.xpath("//*[@id='pane-Episodes']/div/div/div/div[1]/div[2]/ul//li"));
                            ...
                            for (int s = 0; s < season.size(); s++) {
                                ...
                                driver.findElement(By.xpath(
                                                "//*[@id='pane-Episodes']/div/div/div/div[1]/div[2]/ul/li[" + (s + 1) + "]/a"))
                                        .click();
                                ...
                                for (int i = 0; i < 40; i++) {
                                    ...
                                    if (js23.executeScript("return document.readyState").toString()
                                            .equals("complete")) {
                                ...
                                for (int e = 0; e < 10; e++) {
                                    try {
                                        ...
                                        driver.findElement((By.xpath("(//a[@data-uia='play-button'])[1]")))
                                                .getAttribute("href");
                                        e = 100;
                                ...
                                for (int uu = 0; uu < 10; uu++) {
                                    try {
                                        WebElement nex = driver.findElement(By.xpath(
                                                "/html/body/div[1]/div/div/div[1]/div[1]/div[2]/div/div[1]/div[2]/div/div/div/div/div/div/div[2]/div/div/span[@class='handle handleNext active']/b"));

                                        List<WebElement> episode_l = driver
                                                .findElements(By.xpath("//a[@data-uia='play-button']"));
                                        timestamp = new Timestamp(System.currentTimeMillis());
                                        // System.out.println(timestamp);
                                        t = String.valueOf(timestamp);
                                        ...
                                        for (int e = 0; e < episode_l.size(); e++) {
                                            ...
                                            String season_t = driver
                                                    .findElement(
                                                            By.xpath("//*[@id='pane-Episodes']/div/div/div/div[1]/div"))
                                                    .getText();
                                            String show_name = driver
                                                    .findElement(By
                                                            .xpath("/html/body/div[1]/div/div/div[1]/div[1]/div[2]/div/div[1]/div[2]/h1/a/div/img"))
                                                    .getAttribute("alt");

                                            String episode = driver
                                                    .findElement(
                                                            By.xpath("(//a[@data-uia='play-button'])[" + (e + 1) + "]"))
    ...
    private void initialize() {
        ...
        lblNewLabel_1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                 ...
                 *
                 * if ((value1.equals("SELECT HOUR")) ||
                 * txtztmxpgkxfbvlvyaccbqmnueswaspmsvw.getText().equals("") ) {
                 * JOptionPane.showMessageDialog(
                 * null,"PLEASE SELECT REPEAT HOUR / INSERT SPREADSHEET ID");
                 *
                 * } else{
                 *
                ...
                if (path.isEmpty() || textField_1.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(null,
                            "Please insert netlfix account login / Import excel sheet containing show link");
                    ...
                    if (file.renameTo(sameFileName)) {
                        ...
                        try {
                            ...
                            if (System.getProperty("os.name").toLowerCase().contains("windows")) {
                                ...
                                // rt.exec("taskkill /T /F /PID " +
                                // Long.parseLong(processName)); // Supply the
                                // PID value as string
                                // rt.exec("taskkill /F /FI \"WINDOWTITLE eq " +
                                // processName + "\" /T"); // Supply the window
                                // title bar text.
                                // If you want to kill only a single instance of
                                // the
                                // named process then get its PID value and use:
                                // "taskkill /T /F /PID PID_Value" OR you can
                                // provide
